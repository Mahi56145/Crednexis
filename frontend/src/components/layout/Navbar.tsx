        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <>
                <button
                  className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full border border-border/60 hover:border-neon-cyan transition"
                ...
                <NeonButton variant="outline-cyan" size="sm" onClick={() => navigate("/dashboard")}>Dashboard</NeonButton>
                <NeonButton variant="outline-pink" size="sm" onClick={logout}>
                  Logout
                </NeonButton>
              </>
            ) : (
